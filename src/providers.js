export const MAIL_PROVIDERS = {
  ...
  mailcom: {
    id: "mailcom",
    name: "mail.com",
    accountLabel: "mail.com 母号",
    description: "mail.com 母号与官方分裂别名",
    shortDescription: "mail.com 母号 · 官方分裂别名",
    authMode: "password",
    connectionLabel: "登录状态",
    reconnectLabel: "更新密码",
    supportsOfficialAliases: false,
    supportsPlusAliases: false,
    supportsImportedAliases: true,
    supportsDirectRegistration: true,
    capabilityTitle: "母号与官方分裂别名",
    capabilityDescription: "登记同一母号下的 mail.com 官方别名，共用登录密码和收件箱，可直接用于注册",
  },
  netease: {
    id: "netease",
    name: "网易邮箱",
    accountLabel: "网易邮箱母号",
    description: "163、126、yeah 母号与 @aka.yeah.net 替身邮箱",
    shortDescription: "163 · 126 · yeah · aka.yeah.net",
    authMode: "imap_auth_code",
    connectionLabel: "IMAP 状态",
    reconnectLabel: "更新授权码",
    supportsOfficialAliases: false,
    supportsPlusAliases: false,
    supportsImportedAliases: true,
    supportsDirectRegistration: true,
    capabilityTitle: "母号与 @aka.yeah.net 替身邮箱",
    capabilityDescription: "使用网易客户端授权码连接母号，并登记同一收件箱中的 @aka.yeah.net 替身邮箱",
  },
  inbox_link: {
    id: "inbox_link",
    name: "链接取件",
