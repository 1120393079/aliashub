...
export default function AddressesPage({ refreshKey, onDataChange, onNavigate, initialAccountId }) {
  ...
  const kindItems = [{ value: "all", label: "全部" }, { value: "primary", label: "源头号" }, ...(supportsAddressAliases ? [{ value: "official", label: selectedAccount?.provider === "icloud" ? "别名 / 反代" : "官方别名" }] : []), { value: "split", label: "分裂地址" }];
