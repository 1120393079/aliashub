...
- Added pause, resume, and cancel-remaining controls for individual registration
  tasks, plus a persistent queue-wide pause that also holds newly submitted work.
