...
# Sanitized PayPal regression: an hCaptcha site key was rejected by YesCaptcha
...
class YesCaptcha(BaseCaptcha):
    ...
    def solve_hcaptcha(self, page_url: str, site_key: str) -> str:
        ...
        Sanitized PayPal evidence (`checkout-example.har`
        ...
        ``ERROR_DOMAIN_NOT_ALLOWED``（sanitized failure-log fixture）。
