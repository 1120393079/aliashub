...
_BUILTIN_DEFINITIONS: list[dict] = [
    ...
    {
        "provider_type": "mailbox",
        "provider_key": "dispose_inbox_link",
        "label": "链接取件邮箱池（dispose.lol）",
        "description": "粘贴已有邮箱和 dispose.lol 取件链接；批量注册时每个任务独占一行并自动读取验证码",
        "driver_type": "dispose_inbox_link",
        "default_auth_mode": "pool",
        "enabled": True,
        "category": "custom",
        "auth_modes": [{"value": "pool", "label": "取件链接池"}],
        "fields": [
            {
                "key": "dispose_inbox_link_pool_text",
                "label": "邮箱 + 取件链接",
                "type": "textarea",
                "secret": True,
                "category": "auth",
                "placeholder": "email@example.com https://dispose.lol/ib/xxxxxxxx",
                "hint": "每行一组，以空格隔开；系统会校验、去重并按注册任务独占分配，日志不显示完整取件密钥。",
            },
            {
                "key": "dispose_inbox_link_poll_interval",
                "label": "轮询间隔秒",
                "default_value": "3",
                "placeholder": "3",
                "category": "query",
